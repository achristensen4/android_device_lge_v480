...
# v4xx common directory
V4XX_PATH := device/lge/v4xx-common

# Overlay
DEVICE_PACKAGE_OVERLAYS += $(V4XX_PATH)/overlay
...
# System properties
-include $(V4XX_PATH)/system_prop.mk
...
# Audio
PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/configs/mixer_paths.xml:system/etc/mixer_paths.xml
...
# Audio configuration
PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/configs/audio_policy.conf:system/etc/audio_policy.conf
...
# IRSC
PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/configs/sec_config:system/etc/sec_config

# Keylayout
PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/keylayout/gpio-keys.kl:system/usr/keylayout/gpio-keys.kl

PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/idc/qwerty2.idc:system/usr/idc/qwerty2.idc \
    $(V4XX_PATH)/idc/qwerty.idc:system/usr/idc/qwerty.idc \
    $(V4XX_PATH)/idc/touch_dev.idc:system/usr/idc/touch_dev.idc
...
# Media
PRODUCT_COPY_FILES += \
    $(V4XX_PATH)/configs/media_codecs.xml:system/etc/media_codecs.xml
